...
Route::get('search-account-trans',
...
Route::get('search-warehouse-product',
    function (Request $request) {
        return searchProduct($request->q);
    }
);

Route::get('search-delivery-man',
    function (Request $request) {
...
Route::get('search-purchased-product',
    function (Request $request) {
...
Route::get('search_supplier_info',
    function (Request $request) {
...
Route::get('money-receipt-search-client',
    function (Request $request) {
...
Route::get('search-client-wise-invoice',
    function (Request $request) {
