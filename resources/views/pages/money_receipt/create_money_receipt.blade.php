                  ...
                  <div class="row g-3 mb-3 align-items-center">
                    <div class="col">
                      <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="{{url('money-receipt')}}">Money Receipt</a></li>
    ...
    <form class="row maskking-form" id="money_receipt_form">
        ...
        <!--Hidden Inputs-->
        <input type="hidden" name="money_receipt_client_id" id="money_receipt_client_id" value="">
                                    ...
                                    <table class="items">
                                        ...
                                        <div id="billingDetailsList">
                                            <tr class="item-row billing-details-row">
                                                ...
                                                <td><textarea class="cost" name="money_receipt_invoice_due_amount" id="money_receipt_invoice_due_amount" readonly></textarea></td>
                                                <td><textarea class="cost " data-row="1" name="money_receipt_amount" id="money_receipt_amount"></textarea></td>
                                                <td><textarea class="qty " name="money_receipt_discount" data-row="1" id="money_receipt_discount"></textarea></td>
                                                <td><input type="date" class="qty" data-row="1" name="money_receipt_date" id="money_receipt_date"></td>
                                            </tr>
                                        </div>
                                        </tbody>
                                    </table>
    ...
    $(document).ready(function(){
      ...
      function  getInvoiceData(id){
                    ...
                    success: function (data) {
                        ...
                        $("#money_receipt_invoice_net_total").text(data.content[0].grand_total);
                        $("#money_receipt_invoice_due_amount").text(data.content[0].grand_total - data.content[0].total_paying);
...
//                        alert(hiddenClientId);
                        $.ajax({
                            type: "GET",
                            url: "{{ url('search-client-wise-invoice') }}/",
                            dataType: "json",
                            data: {
                                q: hiddenClientId,
                            },
