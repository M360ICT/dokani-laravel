        ...
        <div class="login">
            <div class="wrap">
                ...
                <div class="content">
                    ...
                    <div id="slideshow">
                        <div class="one">
                            <h2><span>POS & SALES</span></h2>
                            <p>Record your inventory and analyze your sales</p>
                        </div>
                        <div class="two">
                            <h2><span>CLIENT DUE</span></h2>
                            <p>Sale with due amount</p>
                        </div>
                        <div class="three">
                            <h2><span>PAYMENTS</span></h2>
                            <p>Receive client payments anytime, anywhere</p>
                        </div>
                        <div class="four">
                            <h2><span>Warehouse</span></h2>
                            <p>Manage warehouses & inventory</p>
                        </div>
                    </div>
                </div>
                <!-- LOGIN FORM -->
                    	...
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                    			<form class="login-form" action="{{ route('login') }}" method="post">
                                            @csrf
                                            <input type="text" class="input" @error('email') is-invalid @enderror id="user_login" autocomplete="off" name="email" placeholder="Your Email">
                                              @error('email')
