  <div class="sidebar p-2 py-md-3 @@cardClass">
      <div class="container-fluid">
          ...
          <div class="title-text d-flex align-items-center mb-4 mt-1">
              <h4 class="sidebar-title mb-0 flex-grow-1"><span class="sm-txt">D</span><span>okani</span></h4>
              ...
              <ul class="menu-list">
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Account">
                          <li><a class="ms-link" href="{{url('money-receipt/create')}}">Receive Client Payment</a></li>
                 ...
                 <li class="collapsed">
                     <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu_Permission" href="#">
                     ...
                     <ul class="sub-menu collapse" id="menu_Permission">
                         <li><a class="ms-link" href="{{ url('permissions/create') }}">Add Permission</a></li>
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Products">
                          <li><a class="ms-link" href="{{url("products/create")}}">Add New Product</a></li>
                          <li><a class="ms-link" href="{{url("products")}}">List of Products</a></li>
                      </ul>
                  </li>
                  <li class="collapsed">
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Transfer">
                          <li><a class="ms-link" href="{{url("transfer/create")}}">Add New Warehouse To Warehouse</a></li>
                          <li><a class="ms-link" href="{{url("transfer")}}">List of Warehouse To Warehouse</a></li>
                          <li><a class="ms-link" href="{{url("warehouse-branch-transfer/create")}}">Add New Warehouse To Branch</a></li>
                          <li><a class="ms-link" href="{{url("warehouse-branch-transfer")}}">List of Warehouse To Branch</a></li>
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Cashbook">
                          ...
                          <li><a class="ms-link" href="{{url("account/create-opening-balance")}}">Add New Opening Balance</a></li>
                          <li><a class="ms-link" href="{{url("account-transfer/create")}}">Transfer Balance</a></li>
                          <li><a class="ms-link" href="{{url("account-transfer")}}">Transfer History</a></li>
                          <li><a class="ms-link" href="{{url("account/balance-statement")}}">Balance Statement</a></li>
                          <li><a class="ms-link" href="{{url("account/non-invoice-income")}}">Non Invoice Amount</a></li>
                      </ul>
                  </li>
                  <li class="collapsed">
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Client">
                          <li><a class="ms-link" href="{{url("client/create")}}">Add New Client</a></li>
                          <li><a class="ms-link" href="{{url("client")}}">List of Clients</a></li>
                          {{-- <li><a class="ms-link" href="">Whole Sale Client</a></li>
                          <li><a class="ms-link" href="">Online Sale Client</a></li> --}}
                      </ul>
                  </li>
                  <li class="collapsed">
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Report">
                          <li><a class="ms-link ms-2" href="{{url("report/date-wise-transfers-report")}}">Date Wise Transfers report</a></li>
                          <li><a class="ms-link" data-bs-toggle="collapse" data-bs-target="#menu-Sales" href="#">

                                  <span class="ms-2">Sales</span>
                                  <span class="arrow fa fa-angle-right ms-auto text-end"></span>
                              </a>
                              <ul class="sub-menu collapse" id="menu-Sales">
                                  <li><a class="ms-link" href="{{url("")}}">Date Wise Transfers report</a></li>
                                  <li><a class="ms-link" href="{{url("")}}">Date Wise total Sales</a></li>
                                  <li><a class="ms-link" href="{{url("")}}">Customer Wise Sales Report</a></li>
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="menu-Purchase">
                                  ...
                                  <li><a class="ms-link" href="{{url("")}}">Details Date Wise Purchase </a></li>
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="menu-Logistict">
                                  ...
                                  <li><a class="ms-link" href="{{url("delivery-vehicles")}}">Delivery Vehicles</a></li>
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="menu-Profitloss">
                                  <li><a class="ms-link" href="{{url("reports/profit-loss")}}">Profit / loss</a></li>
                      ...
                      <ul class="sub-menu collapse" id="menu-Settings">
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="ExpenseHeadings">
                                  <li><a class="ms-link" href="{{url("expense-head/create")}}"> Add New Head</a></li>
                                  <li><a class="ms-link" href="{{url("expense-head")}}"> List of Head</a></li>
                                  <li><a class="ms-link" href="{{url("expense-sub-head/create")}}"> Add New Sub Head</a></li>
                                  <li><a class="ms-link" href="{{url("expense-sub-head")}}"> List of Sub Head</a></li>

                              </ul>
                          </li>
                          <li class="collapsed">
                              <a class="m-link" data-bs-toggle="collapse" data-bs-target="#ProductCategories" href="#">
                              ...
                              <ul class="sub-menu collapse" id="ProductCategories">
                                  <li><a class="ms-link" href="{{url("product-category")}}"> List of Catagories</a></li>
                                  <li><a class="ms-link" href="{{url("product-category/create")}}"> Add New Catagory</a></li>
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="Warehouses">
                                  ...
                                  <li><a class="ms-link" href="{{url('warehouse-branch-transfer')}}"> Warehouse Branch Transfer</a></li>
                          ...
                          {{-- <li class="collapsed">
                              <a class="m-link" data-bs-toggle="collapse" data-bs-target="#ProductColor" href="#">
                                  ...
                                  <span class="ms-2">Attribute Values</span>
                                  <span class="arrow fa fa-angle-right ms-auto text-end"></span>
                              </a>
                              <!-- Menu: Sub menu ul -->
                              <ul class="sub-menu collapse" id="ProductColor">
                                  <li><a class="ms-link" href="{{url("attribute-values")}}"> List of Attribute Values</a></li>
                                  <li><a class="ms-link" href="{{url("attribute-values/create")}}"> Add New Attribute Values</a></li>
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="ProductSize">
                                  ...
                                  <li><a class="ms-link" href="{{url("attributes/create")}}"> Add New Attributes</a></li>
